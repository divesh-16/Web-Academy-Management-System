...
<div class="change-password-card">
    ...
    <form action="./CoachChangePassword" method="post">
    	<div class="form-group">
            <label for="sid">Coach ID : </label>
            <input name="cid" type="number" class="form-control" id="currentPassword" placeholder="Enter current password" required>
        </div>
        <div class="form-group">
