  ...
  <head>
    ...
    <script>
    	...
    	function modify(id)
    	{
    		...
    		fetch("http://localhost:8080/Sports-Management-Servlet-JDBC/AccessoriesDelete",
    				{
    					method:'POST',
    					body : new URLSearchParams({'aid':id})
    				})
...
<h2 class="text-center mt-4">Accessories Information</h2>

<!-- Search Logic -->
<div class="container-fluid mt-3 d-flex justify-content-end">
    <form class="d-flex" role="search" method="get" action="./AccessoriesDelete">
...
%>
			<tr id="<%=taid %>" class = "<%=cls%>">
		      ...
		      <td><input type="button" value="Delete" class="btn btn-primary" onclick="modify(<%=taid %>)"></td>
	    	</tr>
<%		
