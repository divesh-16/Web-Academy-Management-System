  ...
  <head>
    ...
    <script>
    	...
    	function modify(id)
    	{
    		...
    		fetch("http://localhost:8080/Sports-Management-Servlet-JDBC/SupplierDelete",
    				{
    					method:'POST',
    					body : new URLSearchParams({'spid':id})
    				})
...
<div class="container-fluid mt-3 d-flex justify-content-end">
    <form class="d-flex" role="search" method="get" action="./SupplierDelete">
...
%>
			<tr id="<%=tspid %>" class = "<%=cls%>">
		      ...
		      <td><input type="button" value="Delete" class="btn btn-primary" onclick="modify(<%=tspid %>)"></td>
	    	</tr>
<%		
